...
- `lotline-recording-guide.pdf` — six-page guide with verbatim scripts, screen actions, evidence text, and entry checklist.
- `lotline-demo-captions.srt` — 28 cues on the planned 0:00–3:00 timeline; retime to the final voice recording.
- `devpost-copy.md` — title, tagline, narrative, and the six required presentation sections.
- `demo-script-3min.md` — word-for-word narration with screen actions and recording preparation.
- `pitch-60sec.md` — short spoken pitch.
- `judge-qa.md` — candid answers on originality, safety, business, and validation.
- `submission-checklist.md` — exact remaining entry steps and verified deadlines.
